...
:::image type="content" source="../media/5-get-started-ge.png" alt-text="Microsoft Graph get started with user profile.":::
...
:::image type="content" source="../media/5-test-queries.png" alt-text="Test queries with your own account in Graph Explorer.":::
...
:::image type="content" source="../media/5-test-queries-result.png" alt-text="Test queries result with your own account in Graph Explorer.":::
...
:::image type="content" source="../media/5-post-request.png" alt-text="Post request in Microsoft Graph Explorer.":::
...
:::image type="content" source="../media/5-post-request-result.png" alt-text="Post request result in Microsoft Graph Explorer.":::
...
:::image type="content" source="../media/5-post-request-result-teams.png" alt-text="Post request result in Microsoft Teams.":::
...
:::image type="content" source="../media/5-consuming-graph.png" alt-text="Consume Microsoft Graph in your apps with the help of Graph Explorer.":::
