...
1. Demonstrate how to use the web part property pane in SharePoint Framework developed web parts
1. Create a custom property pane field control for use in a SharePoint Framework client-side web part
1. Demonstrate how to incorporate third-party property pane controls in custom SharePoint Framework client-side web parts
