...
You can choose to create the project using plain HTML, CSS and JavaScript, or using Angular or React. JavaScript and Typescript are options as well.

To create an Office Add-in project with the Yeoman generator, complete the following steps.

1. Run the following command to globally install Yeoman and the Yeoman generator for Office Add-ins using NPM.
...
## Validate an Office Add-in's manifest file
