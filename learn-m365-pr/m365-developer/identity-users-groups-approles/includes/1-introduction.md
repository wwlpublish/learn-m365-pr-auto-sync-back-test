...
1. Demonstrate how to obtain security groups as a claim in the token and use them in the app
1. Demonstrate how to use app roles to grant users access to an app
