...
![Screenshot of the application configuration](../media/02-aad-portal-newapp-authentication.png)
...
![Screenshot of the Certificates & Secrets page in the Azure AD admin center](../media/02-aad-portal-newapp-secret.png)
