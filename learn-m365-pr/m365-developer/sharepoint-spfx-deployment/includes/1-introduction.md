...
1. Demonstrate how to deploy a SharePoint Framework solution to production
1. Explain the differences between tenant and site App Catalogs
1. Demonstrate how to update SharePoint Framework project versions
...
This module is also available as a screencast: [SharePoint Framework Training - Developing with the SharePoint Framework: Deploying SharePoint Framework components to production](https://www.youtube.com/watch?v=DLi6ZviEIJ8)