...
![Screenshot of the prompts and answers for the Yeoman generator.](../media/03-yo-office-sso-add-in.png)
...
![Screenshot of Redirect URIs section.](../media/03-azure-ad-authentication-redirect-uri.png)

Also note the section **Implicit grant and hybrid flows** has been updated to ensure Azure AD returns access tokens and ID tokens when a user authenticates to the app:

![Screenshot of Implicit grant and hybrid flows selection.](../media/03-azure-ad-authentication-implicit.png)
...
![Screenshot showing ID and authorized clients who can access the add-in's API.](../media/03-azure-ad-expose-api.png)
...
![Screenshot of add-in in Word.](../media/03-test-app-01.png)
