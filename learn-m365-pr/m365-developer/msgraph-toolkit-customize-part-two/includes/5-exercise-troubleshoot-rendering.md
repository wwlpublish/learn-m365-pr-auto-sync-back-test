In this exercise, you'll learn how to examine data available in Microsoft Graph Toolkit components. You will also ensure that components are rendered consistently within your web app.
Prepare the web app
