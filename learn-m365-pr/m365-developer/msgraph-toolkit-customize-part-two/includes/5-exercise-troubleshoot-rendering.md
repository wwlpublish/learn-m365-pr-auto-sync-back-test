...
1. Verify that the web app works as expected. In Visual Studio Code, run Live Server to test your app. Open your browser, and go to https://localhost:3000. You should see a list of events.
...
1. In Visual Studio Code, run Live Server to test your app. Open your browser, and go to https://localhost:3000. You should see a list of events.
...
1. In Visual Studio Code, run Live Server to test your app. Open your browser, and go to https://localhost:3000. You should see a list of events displayed that use your web app's font color.
