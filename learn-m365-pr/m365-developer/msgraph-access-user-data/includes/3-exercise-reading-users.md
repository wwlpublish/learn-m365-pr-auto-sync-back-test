...
![Screenshot of the User.Read.All permission in the Request API permissions panel](../media/aad-portal-newapp-permissions-03-04.png)
...
Add the following code to issue many requests to Microsoft Graph. This code will request all users from the current organization and write them to the console.
