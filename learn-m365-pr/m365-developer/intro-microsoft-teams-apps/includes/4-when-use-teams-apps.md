...
In general, apps built for Microsoft Teams fit seamlessly into the Teams client. This is really good for your users, typically they don't think about the thing that they're using as an "app"; they just click a button, search for a thing, and the correct card shows up in a conversation. However, this means that in most cases your app is not featured in any particular context. If your app is only designed to be used rarely, it can be easy for users to forget it is there. Most successful apps stay top-of-mind for users through regular use.
