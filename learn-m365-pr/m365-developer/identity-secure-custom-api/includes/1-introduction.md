...
1. Create a custom web app that calls a custom web API secured with Microsoft identity
1. Create a custom daemon app that calls a custom web API secured with Microsoft identity
