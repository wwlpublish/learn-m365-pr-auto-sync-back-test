...
[:::image type="content" source="../media/7-interactive-guide.png" alt-text="Cover for interactive guide that reads Restrict access to Windows Update features using Group Policy." border="false":::](https://edxinteractivepage.blob.core.windows.net/edxpages/cloud-managed-devices-learning-module/Restrict-access-to-Windows-Update-features-through-Group-Policy/index.html)
