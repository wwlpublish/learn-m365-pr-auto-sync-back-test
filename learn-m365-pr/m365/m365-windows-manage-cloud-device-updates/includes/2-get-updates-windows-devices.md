...
- **Group Policy: Don't allow update deferral policies to cause scans against Windows Updates**. Don't enable this Group Policy or the [Update/DisableDualScan](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update?azure-portal=true) CSP policy.
