...
If you're not familiar with the top initiatives of your organization: STOP! Step away from this training, and go find out what is most important to your company. Consider three key perspectives in the following order:

1. Your customers
2. Your employees
3. Your executives

Successful organizations put the customer's needs at the top of the priority list. This should then be balanced with the needs of the employees to deliver on customer needs. Finally your executives have a vision and specific needs you must weave into the customer and employees' objectives. 
...
In the context of this training, we assume you are implementing one change at a time. In the real-world, multiple changes occur at once. Though you might not be directly responsible for all of the changes, you may need to coordinate with other project and portfolio managers to ensure seamless coordination. 
