...
- Real-time (API-based App Connectors) Cloud App Security mechanisms

Data protection is a key pillar in Cloud App Security, and throughout Cloud App Security, you can implement data protection in many areas:
...
- Implement data loss prevention (DLP) using the Cloud App Security Proxy.
- Implement Azure Information Protection (AIP) with Cloud App Security.

This blog series' initial focus will be discussing the end user's experience with each of the connected apps. You can review the content in this blog here: [MCAS Data Protection]( https://techcommunity.microsoft.com/t5/microsoft-security-and/alert-new-blog-series-mcas-data-protection/ba-p/1796898?azure-portal=true).
...
> [!TIP]
> You can locate additional articles that relate to Microsoft Cloud App Security by visiting the [Microsoft Security and Compliance](https://techcommunity.microsoft.com/t5/microsoft-security-and/bg-p/MicrosoftSecurityandCompliance?azure-portal=true) website, and selecting **Filter by label** and choosing **Microsoft Cloud App Security**.
