With your help, Contoso investigated how to improve the image management for their Windows Virtual Desktop environment. The IT team has spent a lot of time managing applications and Windows updates in each individual image required by different departments. By using the MSIX app attach layering technology from Microsoft, they separated the process of application delivery from the master image. 
