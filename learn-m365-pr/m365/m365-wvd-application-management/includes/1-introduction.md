...
Most of Contoso's employees are using Windows 10 devices, and they often work from remote locations. All the employees are using Microsoft 365 apps. Users from different departments are using different applications that require multiple images to be created. The Contoso IT director knows that image management is time consuming and requires management of the applications and Windows updates for each image.
...
- Intermediate-level experience with:
  ...
  - Microsoft compute, storage, networking, and virtualization technologies.
