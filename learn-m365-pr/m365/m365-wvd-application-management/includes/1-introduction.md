...
Contoso is considering using the new Microsoft application delivery technology, MSIX app attach, to separate applications from primary images. As a senior administrator, you've been asked to adopt the application delivery method and to use MSIX app attach in your Windows Virtual Desktop environment.
