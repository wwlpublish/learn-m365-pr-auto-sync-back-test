...
:::image type="content" source="../media/proxy-architecture.png" alt-text="A diagram that describes the role of Defender for Cloud Apps architecture as detailed in the preceding text.":::

### Discovery capabilities of Defender for Cloud Apps versus Azure Active Directory

Azure Active Directory (Azure AD) Premium P1 includes a feature called Azure AD Cloud App Discovery. This feature is based on Microsoft Defender for Cloud Apps Cloud Discovery features. However, Microsoft Defender for Cloud Apps Cloud Discovery provides extra capabilities, as described in the following table.
