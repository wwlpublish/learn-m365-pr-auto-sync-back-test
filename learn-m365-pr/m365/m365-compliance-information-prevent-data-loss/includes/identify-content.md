...
:::image type="content" source="../media/data-classification.png" alt-text="Screenshot shows the data classification window, with credit card number, SWIFT code, and EU debit card number highlighted.":::
...
:::image type="content" source="../media/activity-explorer.png" alt-text="Screenshot shows the activity explorer window, with a bar chart that maps the activities during a set time period.":::
