...
| ![Step 5 icon](../media/step-5-icon-intro.png) |**Step 5: Update your security and compliance configuration.** Moving to Windows 10 and Microsoft 365 Apps allows organizations to take advantage of security features not available in earlier Windows versions. Whether it’s using the built-in capabilities of Windows 10 with virtualization-based security or cloud services like Advanced Threat Protection, securing and protecting endpoints, identity, and data is critical. |
