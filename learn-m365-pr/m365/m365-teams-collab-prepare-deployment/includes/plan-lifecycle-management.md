...
Typically, the stages of each team’s lifecycle include a beginning (Initiate), middle (Active), and end (Sunset), when the team has completed its purpose and reached the end of its useful life.
