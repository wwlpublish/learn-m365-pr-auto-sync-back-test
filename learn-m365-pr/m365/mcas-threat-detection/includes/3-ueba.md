...
UEBA uses machine learning to look at patterns of human behavior and statistical analysis to identify malicious or risky behavior. This can identify the riskiest users in your organization and their potential impact on your organization.
...
![Microsoft Cloud App Security dashboard](../media/3-mcasdashboard.png)

If you select a user, you can see the details of their investigation priority score.

[!div class="mx-imgBorder"]
![Investigation priority score](../media/3-userips.png)
...
[!div class="mx-imgBorder"]
![User actions](../media/3-useractions.png)

The following video discusses UEBA and how UEBA is implemented in Microsoft Cloud App Security:

> [!VIDEO https://www.microsoft.com/en-us/videoplayer/embed/RE4MxJn]
