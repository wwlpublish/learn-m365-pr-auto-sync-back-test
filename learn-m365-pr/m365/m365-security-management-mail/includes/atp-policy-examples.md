...
|**Choose actions**|If email is sent by an impersonated user:<br> Choose **Redirect message to another email address**, and then type the email address of the security administrator. For example, securityadmin@contoso.com.<br>
