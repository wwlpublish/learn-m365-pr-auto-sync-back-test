...
Navigate to **Microsoft Purview compliance portal > Information Governance > Retention to configure retention policies**.
...
Retention policy status is available by selecting the policy on the retention tab of the Information governance solution in the Microsoft Purview compliance portal. Here is a summary of the states the policy might be in:
