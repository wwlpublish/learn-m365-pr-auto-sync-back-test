...
Microsoft delivers more than 200 cloud services (for example, enterprise services such as Microsoft Azure, Microsoft 365, Microsoft Dynamics, and consumer services such as Bing, MSN, Outlook.com, Skype, and Xbox Live) to customers 24x7x365. These services are hosted in Microsoft’s cloud infrastructure composed of globally distributed datacenters, edge computing nodes, and service operations centers, and they are supported by one of the world’s largest global networks – with an extensive fiber footprint – that connects them all.

Since opening our first datacenter in 1989, Microsoft has invested more than $15 billion on infrastructure. The result of these investments is a cloud offering with options allowing customers to meet country and government-specific requirements around the world. This includes our continued commitment to delivering the most trusted cloud for government in the United States. Our US government cloud includes hardened datacenters, geo-replication over 500 miles apart, and 24x7 monitoring by US screened personnel, all of which integrates with existing customer IT environments through the largest network of secure private connections, hybrid database and storage solutions, and data residency.
