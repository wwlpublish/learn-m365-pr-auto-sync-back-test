...
Before you enroll devices to be managed by Microsoft Endpoint Manager and used by members of your organization, you should create the device configuration profiles, the device compliance policies, and the conditional access policies needed by your organization. This module helps you understand and implement the device configuration profiles that you should consider before enrolling devices into Microsoft Endpoint Manager.
