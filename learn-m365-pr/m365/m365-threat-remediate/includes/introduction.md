...
Office 365 ATP provides the following benefits:

- **Industry-leading Protection.** Office 365 ATP leverages 6.5 trillion signals daily from email alone to quickly and accurately detect threats and protect users against sophisticated attacks such as phishing and zero-day malware. Office 365 ATP blocked 5 billion phish emails and analyzed 300k phish campaigns in 2018 protecting 4 million unique users from advanced threats. 
