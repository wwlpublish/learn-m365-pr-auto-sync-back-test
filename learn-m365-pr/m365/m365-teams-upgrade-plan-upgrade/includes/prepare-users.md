To realize maximum value from Teams, users must actually use it. But getting users to change the way they work isn’t always easy. Taking time to understand your users and design the right readiness plan can help facilitate change and accelerate adoption of Teams. You should complete these activities at the same time as your technical readiness preparation:
...
- **Organizational change readiness.** You should determine how receptive your users are to changing the way they work and adopting new technology. Understanding how users react to change empowers your organization to address concerns proactively, adjust your rollout plan to get optimal buy-in, and identify users who can actually help you facilitate the change with their peers.
