...
Office 365 ProPlus and Office 2019 use updated deployment and management tools. The **Office Deployment Tool** is a lightweight setup.exe bootstrapper that can download, install, and configure Office using an XML configuration file. The new **Office Customization Tool** is a web-based interface used to author the XML configuration files. The functionality of both tools are built into System Center Configuration Manager.  
