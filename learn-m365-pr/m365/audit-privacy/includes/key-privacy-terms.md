...
**Data processor:** A natural or legal person, public authority, agency, or other body, which processes personal data on behalf of the controller. In enterprise services, Microsoft acts as a data processor, which processes data in accordance with a customer’ documented instructions to provide the online services or professional services. Microsoft will only process data based on your documented instructions. The volume licensing agreement, including the Data Protection Terms, and the way in which a customer configures and uses the service form a customer’ documented instructions.
...
- compensation (e.g., calculating employee commissions)
- internal reporting and modeling (e.g., forecasting, revenue, capacity planning, product strategy)
