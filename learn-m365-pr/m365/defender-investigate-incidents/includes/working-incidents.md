...
:::image type="content" source="../media/2-attack-chain-overpass-the-hash-spear-phishing-lateral-movement.png" alt-text="Diagram showing the initial access through spear-phishing and lateral movement through overpass-the-hash attack." lightbox="../media/2-attack-chain-overpass-the-hash-spear-phishing-lateral-movement.png" border="false":::
...
:::image type="content" source="../media/2-incidents-ss-incidents-filters.png" alt-text="Screenshot showing the use of Filters in the incident queue." lightbox="../media/2-incidents-ss-incidents-filters.png" border="false":::
...
:::image type="content" source="../media/2-incidents-manage.png" alt-text="Screenshot showing how to manage incidents." lightbox="../media/2-incidents-manage.png" border="false":::
...
:::image type="content" source="../media/2-incidents-example-workflow.png" alt-text="Diagram showing the incident response workflow." lightbox="../media/2-incidents-example-workflow.png" border="false":::
