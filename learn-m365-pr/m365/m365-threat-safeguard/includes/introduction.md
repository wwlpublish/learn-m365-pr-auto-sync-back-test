...
:::image type="content" source="../media/azure-benefits.png" alt-text="The benefits of Microsoft Defender for Identity." border="false":::
...
:::image type="content" source="../media/security-report-improvement-action-cropped.png" alt-text="Security Report user improvement suggestions." border="false":::
...
:::image type="content" source="../media/lateral-movement-across-kill-chain.png" alt-text="Lateral movement across the kill chain." border="false":::
