...
<!-- 5. References (optional) ----------------------------------------------------
    ...
    Example:
        "## References
          * [Administrator role permissions in Azure Active Directory](/azure/active-directory/users-groups-roles/directory-assign-admin-roles.md)
          * [What is Azure role-based access control (Azure RBAC)?](/azure/role-based-access-control/overview.md)
          * [Manage access to billing information for Azure](/azure/billing/billing-manage-access.md)"
 -->
