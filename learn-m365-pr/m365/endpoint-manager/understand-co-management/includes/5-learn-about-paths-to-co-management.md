...
> [!IMPORTANT]
> If you have a hybrid Azure AD that joins your on-premises AD with Azure AD, we recommend you enable co-management for existing Windows 10 or later Configuration Manager devices.
