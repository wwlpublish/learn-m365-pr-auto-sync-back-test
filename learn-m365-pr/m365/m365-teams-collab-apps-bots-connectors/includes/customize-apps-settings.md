...
- **Activity reports**. Use activity reports to see how users in your organization are using Teams. If some don’t use Teams yet, they might not know how to get started or understand how they can use it.

    ![Manage app permissions in the Teams admin center](../media/app-permissions.png)
