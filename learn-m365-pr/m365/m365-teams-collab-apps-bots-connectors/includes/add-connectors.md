...
Office 365 connectors can be used with both Microsoft Teams and Office 365 Groups. Both Microsoft Teams and Exchange use the same connector model, which allows you to use the same connectors within both platforms.
