...
![Anyone link diagram](../media/anyone-link.png)
...
![Specific people link diagram](../media/specific-people-link.png)
...
**Anyone** links are a way to easily share files and folders with guests. However, if you're sharing sensitive information, this may not be the best option. If you want to allow **Anyone** links, there are several options for a more secure sharing experience.
