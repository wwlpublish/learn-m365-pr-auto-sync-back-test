...
- **Conversation** shows all conversations happening in that channel.
- **Files** shows all the files saved to that channel.
- **Wiki** where you can collaborate in real time. 

You can add more tabs to further organize your information.

## Learn more
[Use live captions in a Teams meeting](https://support.microsoft.com/office/use-live-captions-in-a-teams-meeting-4be2d304-f675-4b57-8347-cbd000a21260)

[Search for messages and more in Teams](https://support.microsoft.com/office/search-for-messages-and-more-in-teams-4a351520-33f4-42ab-a5ee-5fc0ab88b263)
