...
:::image type="icon" source="../media/activity.png" ::: Activity**Activity**
...
|:::image type="icon" source="../media/activity.png" ::: Activity Example activity for Contoso|
|-|
...
|:::image type="icon" source="../media/activity.png" ::: Activity Activity for Contoso|
|-|
