...
:::image type="complex" source="../media/path-to-insider-risk.png" alt-text="Infographic that describes the path to malicious insider risk." lightbox="../media/path-to-insider-risk.png" border="false":::
...
:::image type="complex" source="../media/broad-range-of-risks.png" alt-text="Infographic displaying a list of the range of risks posed by insiders." lightbox="../media/broad-range-of-risks.png" border="false":::
	Possible risks include: data spillage, confidentiality violations, IP theft, workplace violence, fraud, policy violations, insider trading, conflicts of interest, sensitive data leaks, workplace harassment, security violations, and regulatory compliance violations.
:::image-end:::
...
:::image type="content" source="../media/insider-risk-management-workflow.png" alt-text="Infographic shows the flow of an insider risk case: policy, alert triage, investigate, and action. This is a collaboration by Compliance, Human Resources, Legal, and Security." lightbox="../media/insider-risk-management-workflow.png" border="false":::
