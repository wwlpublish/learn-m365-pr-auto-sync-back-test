...
**Security policies.** The Active Directory Group Policy settings used for older versions of Windows and Office may not translate directly to Windows 10 and Office 365 ProPlus, and there are different considerations with newer security and compliance capabilities. It’s a good idea to use the **Microsoft Security Compliance Toolkit** to get a baseline of the security policies for current versions of Windows and Office. It’s also worth looking into mobile device management (MDM) policies as part of Microsoft Intune.