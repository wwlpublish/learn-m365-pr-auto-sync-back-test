...
:::image type="icon" source="../media/video-icon.png"::: Watch this video to learn more about how Windows Autopilot can help your organization deploy new devices that are ready to use right out of the box.
