...
> [!div class="centered"]
> :::image type="content" source="../media/threat-modeling-representation.png" alt-text="Diagram showing the components threat modeling: define, diagram, identify, mitigate, and validate." border="false":::
