...
To assist in your move to Office 365 ProPlus, you might want to also use the Readiness Toolkit for Office to test the compatibility of your add-ins and Microsoft Visual Basic for Applications (VBA) macros. The Readiness Toolkit also provides inventory data on the most commonly used add-ins and macros in your organization.
...
Upgrade Readiness assesses browser-based compatibility issues too, identifying websites and web apps that still use ActiveX controls, Browser Helper Objects, VBScript, or other legacy technology not supported by the Microsoft Edge browser. Your users will still need to use Internet Explorer 11 for these sites, and you can add them to the Enterprise Mode site list, using the Enterprise Mode Site List Manager.
