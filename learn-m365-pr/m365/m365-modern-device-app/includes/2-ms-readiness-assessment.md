...
Windows Analytics Upgrade Readiness offers many advantages over traditional desktop management systems and is our recommended tool for assessing your organization’s readiness. It is agentless and guides you through what needs to be done, making use of application and driver compatibility information gathered through the upgrade of hundreds of millions of consumer PCs. This information gives you a detailed assessment, identifying compatibility issues that might block your upgrade, and is supported with links to suggested fixes known to Microsoft.
