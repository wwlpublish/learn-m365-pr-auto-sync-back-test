...
Much like a risk assessment matrix, defining a severity level helps the organization understand map what will happen to the deployment process, for example:
