...
## Microsoft Teams meetings vs. Live Events

The best tool to use for your event depends on the experience you want for your attendees.

:::image type="complex" source="../media/teams-event-experience.png" alt-text="Table showing experience that is best supported by Microsoft Teams.":::
...
:::row:::
    :::column:::
        ...
        :::image type="content" source="../media/teams-logo.png" alt-text="All three applications that support Live Events, Teams, Yammer, and Stream." border="false":::
...
> \** Stream live events are normally only allowed inside your organization. You can make them available outside if you arrange support for your event from the Live Events Assisstance Program (LEAP) team. 
