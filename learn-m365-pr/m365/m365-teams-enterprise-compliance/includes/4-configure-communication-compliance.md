...
|Communication Compliance Investigation    |  Permissions to view message metadata and content, escalate to additional reviewers, escalate to an eDiscovery case, send notifications to users, and resolve the alert.    |
