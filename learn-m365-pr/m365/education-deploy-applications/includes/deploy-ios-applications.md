You can add both free and paid-for iOS applications to Intune for Education. Paid iOS applications require a Volume Purchase Plan (VPP) token.

Here, you'll learn how to deploy free and paid-for iOS applications to Intune for Education.
...
You don't need a VPP token to install free apps, but we recommended it. A VPP token permits you to purchase all apps--free and paid--through the VPP store. Intune silently installs VPP-purchased apps on devices, and doesn't require an Apple ID to authenticate.

If you choose not to use a VPP token to purchase your app, you'll only be able to manage free apps in the Intune for Education. The device user will also need to sign in with an Apple ID to install assigned apps.
...
Added apps appear in the app list, under iOS store. Select the app to view:

- **Overview**: Lists app name, publisher, and date you added it to Intune. Select the app name to see the app in iTunes.
...
1. Select the app.
1. A message appears that prompts you to complete your purchase through Apple School Manager. Select the link to go to Apple School Manager.
