...
We’ll cover hybrid connectivity and how to set it up in more detail in the modules, **Upgrade to Teams from Skype for Business** and **Understanding hybrid connectivity** later in this learning path.
