...
- **Alerts** – Greater visibility into all the alerts across your Microsoft 365 environment, including alerts from Microsoft Cloud App Security, Office 365 Advanced Threat Protection (ATP), Azure Active Directory (Azure AD), and Microsoft Defender ATP.
