...
:::image type="content" source="../media/policy-filter.png" alt-text="Screenshot shows Policy filter wizard.":::
...
:::image type="content" source="../media/policy-message.png" alt-text="Screenshot displays Policy message.":::
