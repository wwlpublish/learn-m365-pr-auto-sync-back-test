...
:::image type="content" source="../media/policy-filter.png" alt-text="Screenshot shows Policy filter wizard with Date, Item class, and Tags selected." lightbox="../media/policy-filter.png" border="false":::
...
:::image type="content" source="../media/policy-message.png" alt-text="Screenshot displays the summary tab showing the Policy message." lightbox="../media/policy-message.png" border="false":::
