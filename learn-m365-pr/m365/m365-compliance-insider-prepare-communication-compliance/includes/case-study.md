...
1. Contoso IT administrators sign into the [**Office 365 Microsoft 365 Defender portal permissions page**](https://security.microsoft.com/permissions?azure-portal=true) using credentials for a global administrator account and select the link to view and manage roles in Office 365.
