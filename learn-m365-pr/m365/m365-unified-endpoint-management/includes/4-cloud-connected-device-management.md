...
o	Single sign on to cloud resources
o	Windows Hello for Business
o	Device Based Conditional Access
o	Automatic Device Licensing
o	Self Service functionality
...
o	Delete company data on lost or stolen devices
o	Rename a device
o	Restart a device
o	Review device inventory
o	Remotely control a device
o	Wipe out pre-installed OEM apps with a Fresh Start reboot
o	Do a factory reset on any Windows 10 device
...
o	Reduce time, costs, and complexity
o	Improve the user experience
o	Use Autopilot and Configuration Manager to migrate existing Windows 7 devices to Windows 10
o	Modernizing device provisioning for all types of workers
