...
7. On the Access review webpage, they can select either the groups and apps that require access reviews, or the access packages:
...
9. The Identity Governance access review pane will then update with the results of the access review, and users denied access will be removed from the group.
