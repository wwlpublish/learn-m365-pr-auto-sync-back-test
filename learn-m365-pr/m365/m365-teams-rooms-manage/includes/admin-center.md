...
![Teams admin center overview page](../media/teams-admin-center-overview.png)
...
![Click on the value in the Start time column of the row marked Poor](../media/troubleshoot-call-quality-1.png)
...
![You can see summary information on the call and a list of participants](../media/troubleshoot-call-quality-2.png)
...
![Click on Network as the poor call quality cause](../media/troubleshoot-call-quality-3.png)
...
![View the round-trip time](../media/troubleshoot-call-quality-4.png)
...
![See what hardware the participant was using from the System icon](../media/troubleshoot-call-quality-5.png)
