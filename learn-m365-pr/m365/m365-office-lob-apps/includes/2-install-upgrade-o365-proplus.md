:::image type="content" source="../media/step-3-office-and-lob-app-delivery-wheel-main.png" alt-text="Step 3 deployment is highlighted on a deployment wheel" border="false":::
...
:::image type="content" source="../media/step-3-office-and-lob-app-delivery-media-7-50.png" alt-text="Screenshot of the Office Customization Tool showing the deployment settings.":::
