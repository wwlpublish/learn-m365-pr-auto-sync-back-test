...
- **Segments** are sets of users that are defined in the Office 365 Security & Compliance Center using a selected **user account attribute**. (See the [list of supported attributes](/microsoft-365/compliance/information-barriers-attributes?view=o365-worldwide?azure-portal=true).)
