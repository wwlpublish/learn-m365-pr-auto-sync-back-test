When you plan an enterprise deployment of Windows 10 and Office 365 ProPlus, it’s important to assess your environment and network, and to make sure your existing hardware and applications will work with the new software. 
...
As part of your testing process, we recommend deploying Windows 10 and Office 365 ProPlus first to a pilot group of users and client devices from across your organization. For example, you might want to include devices from your finance department, because those devices probably include specialized line-of-business (LOB) applications and macros. This pilot group can test the initial deployment of Windows 10 and Office 365 ProPlus as well as future updates. 
