...
Here, you’ll learn how the Microsoft 365 Defender portal, which is part of the Microsoft 365 Defender suite, provides one place to view, investigate, and drill down into security events throughout your company.
...
The Microsoft 365 Defender portal integrates with many different Microsoft Security products and provides a single location where events can be investigated and diagnosed. In Microsoft 365 Defender portal, you can view and analyze security events from across your organization’s identities, data, devices, apps, and infrastructure.

You can access the Microsoft 365 Defender portal at <https://security.microsoft.com>

> [!NOTE]
> Along with Microsoft Defender for Endpoint, Microsoft Defender for Identity, and Microsoft Cloud App Security, the Microsoft 365 Defender portal is a part of the Microsoft 365 Defender security suite. Before October 2020, Microsoft 365 Defender was known as Microsoft Threat Protection.

## Prerequisites

You must have a valid license to access the security center. If you have any of these licenses, you can access the Microsoft 365 Defender portal at no extra cost:
