...
1. Select **Create policy** and then select **File policy**.
    ...
    :::image type="content" source="../media/02-create-file-policy.png" alt-text="A screenshot of the Microsoft Cloud App Security portal showing how to create a file policy.":::
...
1. In the **Create a filter for the files this policy will act on** box, select **File ID**, and then select **is** in the drop-down lists. Then enter the file hash in the third box.
    ...
    :::image type="content" source="../media/02-add-file-filter.png" alt-text="A screenshot of the Microsoft Cloud App Security portal showing how to add a file filter to a policy.":::
