Often, regular users of Microsoft Endpoint Configuration Manager overlook how much they can use **Conditional Access (CA)** and take advantage of the simple, cloud-attached benefits.
...
1. Intune ensures a device or app is managed and secure, based on your organization’s compliance policies (for example, make sure all devices have encryption enabled and are not jailbroken).
...
- [Create a device-based Conditional Access policy](/intune/protect/create-conditional-access-intune?azure-portal=true)
- [What are common ways to use Conditional Access with Intune?](/intune/protect/conditional-access-intune-common-ways-use?azure-portal=true)
- [Create a compliance policy in Microsoft Intune](/intune/protect/create-compliance-policy?azure-portal=true)
- [Monitor Intune Device compliance policies](/intune/protect/compliance-policy-monitor?azure-portal=true)
- [Use compliance policies to set rules for devices you manage with Intune](/intune/protect/device-compliance-get-started?azure-portal=true)
