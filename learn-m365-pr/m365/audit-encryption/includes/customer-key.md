...
:::image type="complex" source="../media/customer-key-hierarchy.png" alt-text="Diagram depicting the Microsoft Customer Key hierarchy." lightbox="../media/customer-key-hierarchy.png" border="false":::
