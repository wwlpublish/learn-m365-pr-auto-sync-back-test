...
- **Customer Key** – This option allows customers to use their own root keys to encrypt customer data. Customer keys are uploaded to or generated within Azure Key Vault, allowing customers to retain control over their keys. This option is currently available for Exchange Online, SharePoint Online, OneDrive for Business, and files in Microsoft Teams.
