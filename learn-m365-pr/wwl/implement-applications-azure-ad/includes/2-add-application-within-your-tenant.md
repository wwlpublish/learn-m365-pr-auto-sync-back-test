...
4.  When the **Create page** appears, enter your application's registration information:
     ...
     *  **Application type:**
         ...
         *  Select **Native** for [client applications](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary?azure-portal=true) that are installed locally on a device. This setting is used for OAuth public [native clients](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary?azure-portal=true).
         *  Select **Web app / API** for client applications and [resource/API applications](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary?azure-portal=true) that are installed on a secure server. This setting is used for OAuth confidential [web clients](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary?azure-portal=true) and public [user-agent-based clients](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary?azure-portal=true). The same application can also expose both a client and resource/API.
    ...
    **Additional reading.** For specific examples of web applications and native applications, see the [Get Started section of the Azure Active Directory for developers](https://docs.microsoft.com/azure/active-directory/develop/active-directory-developers-guide?azure-portal=true) site.
5.  When finished, select **Create**.

After selecting **Create** in the final step, Azure AD assigns a unique Application ID to your application and navigates to your application's main registration page. Depending on whether your application is a web or native application, different options are provided to add extra capabilities to your application. Te next unit continues this discussion by providing an overview of consent and details on enabling more configuration features in your application registration.
