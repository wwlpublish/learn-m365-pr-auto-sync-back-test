...
:::row:::
  :::column:::
    :::image type="content" source="../media/9-accessibility-vision-0fa5ee2f.png" alt-text="Image showing a stylized symbol of an eye for vision":::

  :::column-end:::
  :::column:::
    **Vision** For people who are blind, color blind, or have low vision, these are some Microsoft 365 features that improve visibility:
...
:::row:::
  :::column:::
    :::image type="content" source="../media/9-accessibility-hearing-eb0eb6c6.png" alt-text="A stylized image showing an ear for hearing":::

  :::column-end:::
  :::column:::
    **Hearing** For those who are hard of hearing, have hearing loss, or have deafness, here are some Microsoft 365 features that assist hearing.
...
:::row:::
  :::column:::
    :::image type="content" source="../media/9-accessibility-neurodiversity-bc93e882.png" alt-text="Image showing a stylized head and an outline of the brain":::

  :::column-end:::
  :::column:::
    **Neurodiversity** Innovative tools such as dictation and Windows Hello sign-in can make the digital world more accessible for those who live with dyslexia, seizures, autism, or other cognitive differences.
...
:::row:::
  :::column:::
    :::image type="content" source="../media/9-accessibility-learning-e7c1c94f.png" alt-text="A stylized image showing a human head with linked circles where the brain is":::

  :::column-end:::
  :::column:::
    **Learning** People living with learning difficulties can increase focus, concentration, improve reading and writing skills, and improve understanding with these features in Microsoft 365:
...
:::row:::
  :::column:::
    :::image type="content" source="../media/9-accessibility-mobility-c3df2d68.png" alt-text="A stylised image of a person in a wheelchair, representing mobility":::
...
:::row:::
  :::column:::
    :::image type="content" source="../media/9-accessibility-mental-health-93a42c08.png" alt-text="Image showing a stylized profile of a head with a medical cross where the brain is":::

  :::column-end:::
  :::column:::
    **Mental health** These are assistive technologies for people living with issues such as bipolar disorder, anxiety, PTSD, depression, or ADHD. Microsoft 365 products can help with distraction, reading, and concentration issues.
