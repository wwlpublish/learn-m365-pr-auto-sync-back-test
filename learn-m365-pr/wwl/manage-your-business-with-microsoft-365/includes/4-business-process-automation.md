Every business will have its fair share of time-intensive repetitive tasks that need to be done for the company to operate. These can range from routine email marketing campaigns to the management of employee requests. In today's fast-paced business world, where the customer expects an immediate response to every query, it can be challenging to deliver a quality service.
Business process automation gives your organization the ability to automate time-intensive tasks, optimizing operations, and bringing a new level of efficiency to your organization. Process automation allows your employees to use their skills for the jobs they were hired to do instead of routine tasks that may take up valuable time.
...
:::image type="content" source="../media/4-sharepoint-workflow.png" alt-text="SharePoint workflow":::
...
|------------------------|-----------------------------------------------------------------------------------------|------------------------------------------------------------------------------|
| [Automated flows](https://docs.microsoft.com/power-automate/get-started-logic-flow)        | Create a flow that performs one or more tasks automatically after an event triggers it. | [Connectors](https://docs.microsoft.com/connectors/) for cloud or on-premises services.                                |
| [Button flows](https://docs.microsoft.com/power-automate/introduction-to-button-flows)           | Run repetitive tasks from any place, at any time, via your mobile device.                |                                                                              |
| [Scheduled flows](https://docs.microsoft.com/power-automate/run-scheduled-tasks)        | Create a flow that performs one or more tasks on a schedule.                            |                                                                              |
| [Business process flows](https://docs.microsoft.com/power-automate/business-process-flows-overview) | Define a set of steps for people to follow to take them to the desired outcome.         | Human processes                                                              |
| [UI flows](https://docs.microsoft.com/power-automate/ui-flows/overview)               | Record and automate the playback of manual steps on legacy software.                    | Desktop and Web applications that do not have APIs available for automation. |
