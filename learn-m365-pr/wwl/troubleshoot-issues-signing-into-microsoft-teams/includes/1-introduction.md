...
Since moving to Microsoft 365, your users have been increasingly relaying on Teams for collaboration and communications. It’s therefore important that you’re able to troubleshoot problems relating to member sign-in, account authentication, and network access issues. In addition, because Teams is used to collaborate with external users, you must be able to configure and troubleshoot guest access. 

After completing this module, you’ll know how to troubleshoot account authentication, review sign-in logs, and troubleshoot both member and guest access issues. You’ll also know how to validate network configuration and how to configure conditional access policies..
