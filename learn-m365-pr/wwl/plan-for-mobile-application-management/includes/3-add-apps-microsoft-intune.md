...
| Windows LOB apps                                    | LOB app                   | Select Line-of-business app as the app type, select the App package file, and then enter a Windows installation file with one of the following extensions: .msi, .appx, .appxbundle, .msix, or .msixbundle. |
...
As an organization determines which apps it needs, it should consider the following questions:

 -  How do the apps integrate with cloud services?
 -  What data is accessed by the apps?
 -  Are the apps available to BYOD users?
 -  Do the apps require internet access?
...
An organization can sort apps by using app categories. Doing so makes the apps easier for users to find in the company portal. An organization can assign one or more categories to an app. For example, **Developer apps** or **Communication apps**.
