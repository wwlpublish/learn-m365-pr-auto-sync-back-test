Completing your company’s organization profile is the starting point when setting up your company’s tenant. Some of the properties that must be maintained will cause the provisioning process to halt if they’re incomplete. For example, one such attribute is the Address line. The provisioning process will stop if an organization doesn't have a complete address.
...
The **Organization information** group also contains the country or region for your subscription. **The value of the country/region field can't be changed.** The reason for this restriction is that the country or region where your organization is headquartered determines which services are available to you. It also determines the taxes and billing currency and the location of the Microsoft data center that supports the organization.
