...
For the list of certified compliance recording partners, see [Compliance recording for Teams certification programs](https://docs.microsoft.com/microsoftteams/teams-recording-policy#compliance-recording-for-teams-certification-programs?azure-portal=true).
...
For the list of certified session border controller (SBC), see [Certified SBC vendors](https://docs.microsoft.com/microsoftteams/direct-routing-border-controllers#certified-sbc-vendors?azure-portal=true).
