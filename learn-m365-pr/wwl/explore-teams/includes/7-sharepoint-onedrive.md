...
‎:::image type="content" source="../media/teams-content-sharepoint.png" alt-text="A graphic explains the structure of Teams Channels in SharePoint"  type="icon":::
...
‎:::image type="content" source="../media/teams-content-onedrive.png" alt-text="A graphic explains the structure of Teams chat in OneDrive"  type="icon":::
