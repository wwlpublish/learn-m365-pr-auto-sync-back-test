With Windows 10 or later, in addition to joining an AD DS domain, you can now join a device to Azure AD. Along with creating user accounts in Azure AD, you can now have objects that represent devices in Azure AD, and you can manage devices that are joined to Azure AD from the cloud.
