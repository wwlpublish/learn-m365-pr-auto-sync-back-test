...
3. In the window that appears for the device type you selected, select **Actions** in the upper-right corner of the page and then select **All device tags**.
    ...
    :::image type="content" source="../media/all-device-tags.png" alt-text="Screenshot of selecting all device tags.":::  
...
:::image type="content" source="../media/admin-2.gif" alt-text="Screenshot of managing Teams device tags.":::  
