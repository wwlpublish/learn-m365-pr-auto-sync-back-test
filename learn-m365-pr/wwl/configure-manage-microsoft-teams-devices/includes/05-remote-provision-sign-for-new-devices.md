...
1. In the left-hand navigation pane, select **Devices**, and then select **IP Phones**.
1. On the **IP Phones** window, select the **Actions** drop-down arrow that appears in the upper-right side of the screen. In the drop-down menu that appears, select **Provision devices**.

1. In the **Provision devices** window, you can either add the MAC address manually or upload a file. The following sections cover each approach.
