...
- Use [Azure AD sign in logs](/azure/active-directory/reports-monitoring/concept-sign-ins?azure-portal=true) to verify the account signs in to the Teams Meeting Room.
...
For more information, see [Microsoft Teams Rooms recovery tool](/MicrosoftTeams/rooms/recovery-tool?azure-portal=true).
