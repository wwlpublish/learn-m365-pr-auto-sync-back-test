...
Security alerts that are generated by Defender for Identity are divided into the following categories or phases, which are similar to the phases seen in a typical cyber-attack kill chain:<br>
 ...
 -  [Reconnaissance alerts](https://docs.microsoft.com/defender-for-identity/reconnaissance-alerts?azure-portal=true)
 -  [Compromised credential alerts](https://docs.microsoft.com/defender-for-identity/compromised-credentials-alerts?azure-portal=true)
 -  [Lateral movement alerts](https://docs.microsoft.com/defender-for-identity/lateral-movement-alerts?azure-portal=true)
 -  [Domain dominance alerts](https://docs.microsoft.com/defender-for-identity/domain-dominance-alerts?azure-portal=true)
 -  [Exfiltration alerts](https://docs.microsoft.com/defender-for-identity/exfiltration-alerts?azure-portal=true)
