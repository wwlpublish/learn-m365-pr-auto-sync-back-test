This module examined the various tasks that require messaging administrators to create and manage recipients in Exchange. You learned how to create and manage the following Exchange objects:
