...
1.  Go to [t](https://compliance.microsoft.com/)he Microsoft 365 compliance center and sign in using the credentials of an account that's been assigned the appropriate permissions.
