...
:::row:::
  ...
  :::column-end:::
  :::column:::
    Set this policy to define a limit for the upload bandwidth that a device will utilize for all concurrent upload activity via Delivery Optimization (set in kilobytes \[KB\] per second).
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
