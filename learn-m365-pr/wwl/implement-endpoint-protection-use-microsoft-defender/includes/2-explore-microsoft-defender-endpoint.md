...
Microsoft Defender for Endpoint uses the following combination of technology built into Windows 10 and Microsoft's robust cloud service:
 ...
 -  **Endpoint behavioral sensors**. These sensors are embedded in Windows 10. They begin by collecting and processing behavioral signals from the operating system. They then send this sensor data to an organization's private, isolated, cloud instance of Microsoft Defender for Endpoint.
