...
:::row:::
  ...
  :::column-end:::
  :::column:::
    Scripted installation or Microsoft Intune mobile device management (MDM)
  :::column-end:::
  :::column:::
    Office 365 with MDM, OneDrive admin center, Intune mobile application management (MAM) or MDM
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
  ...
  :::column-end:::
  :::column:::
    Microsoft Endpoint Manager with Intune or Windows Autopilot
  :::column-end:::
  :::column:::
    Microsoft Endpoint Configuration Manager, Group Policy Objects (GPOs), and so on
  :::column-end:::
:::row-end:::
