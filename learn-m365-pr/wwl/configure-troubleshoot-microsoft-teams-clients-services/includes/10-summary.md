As a Teams administrator, you’ve been involved in configuring and troubleshooting Microsoft Teams. Having completed this module, you should now be able to deploy, configure, and maintain Teams client software. You should also be able to troubleshoot Teams client startup and performance issues. Finally, you’ll also know how to configure and troubleshoot Microsoft Audio Conferencing, call setup and troubleshoot phone system issues.
...
- [Hardware decoder and encoder driver recommendations](/microsoftteams/hardware-decoders-and-encoders).
