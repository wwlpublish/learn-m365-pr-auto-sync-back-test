...
:::image type="content" source="../media/windows-adk-features-install-5630cf59.png" alt-text="The ADK installer showing the various tools availble to choose to install.":::
...
DISM can be used to modify images while they are not in use. To edit an existing image, mount the image, make the desired changes, and then dismount the image.<br>

:::image type="content" source="../media/servicing_mount-ce81e592-df1dc7aa.png" alt-text="Graphic that shows the process of mounting an image, modifying the mounted folders, unmounting the image, and then applying to multiple devices.":::
...
### Windows Imaging and Configuration Designer<br>
...
:::image type="content" source="../media/windows-icd-4e902d40-fadb6d25.png" alt-text="The WICD dashboard, showing buttons to create a new provisioning pkg  or image, and buttons to open recent projects.":::
...
:::image type="content" source="../media/mdt-11-fig07-1d0c144e-947c9197.png" alt-text="Windows answer file opened in Windows SIM.":::
...
:::image type="content" source="../media/mdt-11-fig08-d3bf0f01-922fe494.png" alt-text="The VAMT tool dashboard. On the left pane, shows products Office and Windows, as well as VL Reports. The center pane shows inventory and licence counts, the right pane shows actions.":::
...
### Windows Preinstallation Environment (Windows PE)<br>
...
:::image type="content" source="../media/mdt-11-fig09-a0045fa8-8f9a406f.png" alt-text="A machine booted with the Windows ADK default Windows PE boot image.":::
...
:::image type="content" source="../media/mdt-11-fig11-af96b09e-905bf3c6.png" alt-text="Windows Deployment Services using multicast to deploy three machines.":::
...
:::image type="content" source="../media/mdt-11-fig13-9198f864-03073c9b.png" alt-text="The Deployment Workbench in, showing a task sequence.":::
