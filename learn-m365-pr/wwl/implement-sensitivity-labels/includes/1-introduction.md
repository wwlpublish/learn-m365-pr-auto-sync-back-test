...
With your Data Classification framework in place, you'll then learn how to create sensitivity labels and a label policy. The module will then examine how to publish your labels, how to remove labels from a policy, and how to delete labels.
