...
In this module, you'll learn how to implement Microsoft Defender for Cloud Apps. You'll examine how to deploy Defender for Cloud Apps, how to control your cloud apps with policies, and how to troubleshoot Defender for Cloud Apps.

After completing this module, you'll be able to:

 -  Describe how Defender for Cloud Apps provides improved visibility into network cloud activity and increases the protection of critical data across cloud applications.
 -  Explain how to deploy Defender for Cloud Apps.
 -  Control your cloud apps with policies.
 -  Troubleshoot Defender for Cloud Apps.
