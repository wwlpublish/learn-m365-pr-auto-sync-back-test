...
**Additional reading.** For more information, see [How to control cloud apps with policies](https://docs.microsoft.com/cloud-app-security/control-cloud-apps-with-policies?azure-portal=true).
