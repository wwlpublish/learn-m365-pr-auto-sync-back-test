...
## Create a app permission policy
...
4. Under **Microsoft apps**, **Third-party apps**, and **Custom apps**, select one of the following options that is listed in the following graphic:
