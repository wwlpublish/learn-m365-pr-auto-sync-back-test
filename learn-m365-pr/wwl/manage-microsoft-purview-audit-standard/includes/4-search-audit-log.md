...
Thousands of user and administrator operations performed in dozens of Microsoft 365 services and solutions are captured, recorded, and retained in an organization's unified audit log. Users in an organization can use the audit log search tool to search for, view, and export (to a CSV file) the audit records for these operations.
...
Once you've started a search, the results are loaded. After a few moments they're displayed on a new page. When the search is finished, the number of results that were found is displayed.
...
:::image type="content" source="../media/search-results-cb7065ed.png" alt-text="Screenshot showing the number of results that are displayed after the search is finished.":::
