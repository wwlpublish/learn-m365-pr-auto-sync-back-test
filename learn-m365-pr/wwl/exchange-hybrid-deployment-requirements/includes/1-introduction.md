...
In this module, you'll examine the requirements necessary to implement a hybrid deployment. You'll also learn about the features and components that are required when implementing a hybrid deployment.
