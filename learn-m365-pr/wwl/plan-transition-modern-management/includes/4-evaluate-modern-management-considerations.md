...
:::row:::
  :::column:::
    Require the creation golden images
  :::column-end:::
  :::column:::
    Yes
  :::column-end:::
...
After you have considered these requirements, there are two paths for transition:
...
While modern methods are preferred as they offer easier configuration and management, sometimes traditional methods using imaging may be needed. Some of the more common day-to-day scenarios that are likely to require organizations to consider using imaging with modern management include:
 ...
 -  A device experiences a BSOD and cannot boot into Windows at all, resulting in the need for a bare-metal build.
...
This is most-notably in situations such as client storage drive replacements, bare-metal deployments, and devices that do not support an upgrade path to the desired OS.
