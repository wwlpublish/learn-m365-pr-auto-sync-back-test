...
#### In order to use Windows Hello, you must have a PIN for your login already setup. On your PC select the**Start** button, then select **Settings** &gt; **Accounts** &gt; **Sign-in options** to set up Windows Hello. Under Windows Hello, you’ll see options for face, fingerprint, or iris if your PC has a fingerprint reader or a camera that supports it. Once you’re set up, you will be able to sign in with a quick swipe on your fingerprint reader or glance at your camera.<br>
