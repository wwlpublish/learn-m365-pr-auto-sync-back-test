...
To create and manage Teams retention policies, you can use the Microsoft 365 compliance center or PowerShell. To create a retention policy for Teams chats and channel messages, do the:
...
4. For **Decide if you want to retain content, delete it, or both** page of the wizard, specify the configuration options for retaining and deleting content. You can create a retention policy with the options below: 
...
* [Manage retention policies for Microsoft Teams](/microsoftteams/retention-policies)
