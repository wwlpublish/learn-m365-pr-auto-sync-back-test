...
**Additional reading.** For more information, see [What is a Center of Excellence?](/power-platform/guidance/coe/motivation)
...
The dashboard provides analytics and data for the following areas:
 ...
 -  **[Monitor](/power-platform/guidance/coe/power-bi-monitor).** With the Monitor section of the CoE Power BI dashboard, basic inventory (environments, apps, flows, makers, connectors, and audit logs) can be queried to monitor usage across an entire tenant and within each environment. These reports also support drill-downs and filtering. For example, by maker department/country or region/city, connector usage, or premium feature usage.<br>
 -  **[Govern](/power-platform/guidance/coe/power-bi-govern).** An organization will want to use the insights it gathers to drive action, such as performing risk assessments and identifying critical, orphaned, or unused resources. The pages in the Govern section of the CoE Power BI dashboard enable an organization to drive action directly from within the Power BI report through an embedded app. The app can be used to grant ownership of a resource to specific users, archive the resource, or delete it.
 -  **[Nurture](/power-platform/guidance/coe/power-bi-nurture).** As an organization establishes its CoE, a significant part of its activity will be nurturing its maker community and enabling them to follow best practices. It will also want to work with them to identify whether they or their resources need extra support. The Nurture section of the CoE Power BI dashboard helps an organization find its "star" app and flow makers. It also enables an organization to see what connectors it's using, where they're based (department/country or region/city), and how they're adopting Microsoft Power Platform.
