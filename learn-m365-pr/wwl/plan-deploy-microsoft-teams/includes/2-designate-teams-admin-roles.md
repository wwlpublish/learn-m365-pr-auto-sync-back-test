...
6. Select the role to assign to the user (for example, **Teams service admin**), and then select **Save changes**. 
    ...
    :::image type="content" source="../media/assign-teams-admin-roles-microsoft-365-admin-center.png" alt-text="Screenshot of assigning Teams Admin Roles in M365 admin center.":::
...
:::image type="content" source="../media/assign-teams-admin-roles-azure-ad.png" alt-text="Screenshot of assigning Teams Admin Roles in Azure AD.":::
