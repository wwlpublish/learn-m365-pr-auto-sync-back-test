...
> [!IMPORTANT]
> Microsoft 365 Defender is the new name for Microsoft Threat Protection.  [Learn more](https://www.microsoft.com/security/blog/?p=91813). We’ll be updating our products and docs soon, so keep an eye out.
...
> [!IMPORTANT]
>Microsoft Defender for Identity is the new name for Azure Advanced Threat Protection. [Learn more](https://www.microsoft.com/security/blog/?p=91813). We’ll be updating our products and docs soon, so keep an eye out.
...
:::image type="content" source="../media/3-defender-advanced-threat-protection-v3.png" alt-text="Microsoft Defender for Endpoint":::
