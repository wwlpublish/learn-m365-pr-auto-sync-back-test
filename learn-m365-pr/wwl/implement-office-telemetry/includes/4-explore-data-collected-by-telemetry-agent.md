The Telemetry Agent collects inventory, usage, and telemetry data for all the computers that it monitors. The agent then uploads the collected data to a shared folder.
