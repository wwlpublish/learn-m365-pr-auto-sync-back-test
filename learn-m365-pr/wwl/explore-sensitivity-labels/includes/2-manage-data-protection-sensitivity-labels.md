...
Sensitivity labels can be used to:<br>
 ...
 -  **Extend sensitivity labels to third-party apps and services**. Third-party apps that use the Microsoft Purview Information Protection SDK can read sensitivity labels and apply protection settings.
