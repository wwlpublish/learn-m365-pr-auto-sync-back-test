...
Sensitivity labels can be used to:<br>
 ...
 -  **Protect content in third-party apps and services by using Microsoft Defender for Cloud Apps.** With Defender for Cloud Apps, organizations can detect, classify, label, and protect content in third-party apps and services, such as SalesForce, Box, or DropBox. They can do so even if the third-party app or service doesn't read or support sensitivity labels.
