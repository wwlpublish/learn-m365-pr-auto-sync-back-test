...
1.  **Start the on-boarding wizard**. Open the Desktop Analytics portal in Microsoft 365 Device Management as a user with the **Global Admin** role and select **Start** to start the wizard. **Accept service agreement** and c**onfirm your subscription.**
...
3.  **Set up your workspace**. You can either import an existing workspace if you are currently using Windows Analytics or add a new workspace and select the Azure subscription to use. Note that you can only have one Desktop Analytics workspace per Azure AD tenant.
...
3.  Create a app for the Desktop Analytics connection (or use existing if applicable).
...
For more information about controlling what data is sent to Microsoft, refer to [Configure Windows diagnostic data in your organization](https://aka.ms/AA6cpyt).
