...
![A diagram showing Office 365 and an On-Premises environment, linked by Azure Active Directory and Azure AD Connect, with an on-premises Skype for Business Server and Microsoft Teams. Two users (A and B) are homes in Microsoft Teams and two users (C and D) are homed on-premises.](../media/teams-sfb-interaction.png)
