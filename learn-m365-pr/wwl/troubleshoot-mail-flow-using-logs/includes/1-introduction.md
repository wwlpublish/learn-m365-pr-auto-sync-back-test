Event, protocol, and tracking logs are excellent resources for Messaging administrators when they must troubleshoot messaging issues. For example, logs can prove useful when:
...
This module examines how to troubleshoot mail flow issues using message tracking logs, protocol logs, and event logs.
