Once you implement Azure AD Connect, it’s important to remember that you can no longer manage objects using the Microsoft 365 admin center from that point forward.
