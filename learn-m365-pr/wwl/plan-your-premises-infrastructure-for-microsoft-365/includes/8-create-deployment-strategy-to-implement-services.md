...
> [!WARNING]
> This option can be the most complex and costliest to set up depending on your environment.
...
In summary, all resources are bound to the Azure AD user, and the Azure AD user is the "source" for all other resources. These conditions are true for all the deployment strateges that can be used to implement Microsoft 365 services. This concept is depicted in the following diagram.
