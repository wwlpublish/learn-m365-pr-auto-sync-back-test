...
| Owner Moderated | When a OneDrive is used for collaboration with incompatible users in the presence of the site owner/moderator, the OneDrive's IB mode can be set as **Owner Moderated**. For more information, see [Owner Moderated site](https://docs.microsoft.com/onedrive/information-barriers?toc=%2Fmicrosoft-365%2Fcompliance%2Ftoc.json&amp;bc=%2Fmicrosoft-365%2Fbreadcrumb%2Ftoc.json?azure-portal=true). |
