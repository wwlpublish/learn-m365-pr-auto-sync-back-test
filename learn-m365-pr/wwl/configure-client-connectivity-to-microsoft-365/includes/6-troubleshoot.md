...
**Additional reading.** For more information, see [Getting Started with Microsoft Message Analyzer](/message-analyzer/getting-started-with-message-analyzer) and [Microsoft Message Analyzer Operating Guide](https://technet.microsoft.com/library/jj649776.aspx?azure-portal=true).

### Microsoft Remote Connectivity Analyzer tool

‎ The Microsoft Remote Connectivity Analyzer (RCA) tool is a downloadable client program that can:
...
The Microsoft Remote Connectivity Analyzer Tool runs a set of tests locally from a client computer. As such, it enables end users to run similar tests from client computers within the corporate network.
