...
:::image type="content" source="../media/dashboard-enhanced.png" alt-text="Screenshot of Defender for Cloud Apps dashboard." lightbox="../media/dashboard-enhanced.png":::
...
- [Microsoft Defender for Cloud Apps overview](/defender-cloud-apps/what-is-defender-for-cloud-apps?azure-portal=true)

- [Protect apps with Defender for Cloud Apps Conditional Access App Control](/defender-cloud-apps/proxy-intro-aad#featured-apps?azure-portal=true)

- [Defender for Cloud Apps best practices](/defender-cloud-apps/best-practices?azure-portal=true)
