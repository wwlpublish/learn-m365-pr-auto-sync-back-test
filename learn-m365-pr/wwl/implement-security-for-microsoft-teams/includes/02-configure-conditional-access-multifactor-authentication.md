...
2. On left pane, select All services and search for Conditional access, and then select **Azure AD Conditional Access**.
...
4. In the **New** page, insert the following information in the corresponding fields in the sections of the left navigation menu:
